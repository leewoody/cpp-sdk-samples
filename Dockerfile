...
#
# build:
# $ docker build --build-arg AFFECTIVA_AUTO_SDK_URL=$AFFECTIVA_AUTO_SDK_URL --build-arg BRANCH=$BRANCH --tag=affectiva-ics:v2.3.0 .
#
...
# $ docker run -it --rm affectiva-ics:v2.3.0
#
